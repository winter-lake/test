...
<head>
	...
	<title>重置密码</title>
	 ...
	 <link rel="stylesheet" href="<%=contextPath %>/css/zz/zzczmm.css">
</head>
<body>
<!--外围容器-->
<div class="k_contaniner">
	...
	<div class="k_right">
		<div class="content">
			<form class="czmm" action="<%=basePath %>zz/userManage/resetPassword.do" method="post">
...
<script src="<%=contextPath %>/js/zz/zzczmm.js"></script>
<!--end-->
</body>
</html>