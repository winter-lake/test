	...
	<div class="k_right">
		<div class="content">
			...
			<form class="k_change j_search_form" method="post" action="">
				<b class="k-b">
					<i>服务站</i>
					<select id="service_station" name="service_station"></select>
				</b>
			    <b class="k-b">
					<i>供应商</i>
			...
			<!--table-->
			<table class="table table-bordered" style="text-align:center" id="zz_goods_list">
...
<!--end-->
	...
	seajs.use("zz/goods/list", function(view) {
		view.init();
	});
</script>
</body>
