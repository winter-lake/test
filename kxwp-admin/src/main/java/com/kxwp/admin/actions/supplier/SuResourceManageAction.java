 ...
 */
@Controller
@RequestMapping(value="/zz/suResourceManage")
public class SuResourceManageAction {

  @Autowired
  private SuResourceManageService resourceManageService;
  
  @RequestMapping(value="/add.do", method=RequestMethod.POST)
  public ModelAndView add(SuResource resource, HttpServletRequest request){
  ...
  @ResponseBody
  public ExchangeData<Object> modify(@RequestBody List<SuResource>  suResources){
    ExchangeData<Object> exchangeData = new ExchangeData<Object>();
    try {
      resourceManageService.modify(suResources);
    } catch (Exception e) {
      exchangeData.setCallStatus(CallStatusEnum.FAIL);
      exchangeData.setMessage("系统错误，请联系管理员！");
    }
