		...
		<div class="pr_ship_order tx_c">
			<div class="row row1">
				...
				<div class="col col2 tx_md">
					${printSalesOrder_detail.serviceStation_phone}
				</div>
			...
			<div class="row row2">
				...
				<div class="value_w  w_multi_tx" style="width: 6.8rem;">
					<div
						style="display: table-cell; vertical-align: middle; line-height:1.2rem; text-align: center;">${printSalesOrder_detail.salesOrder.print_address}</div>
				</div>
			</div>
			<!-- 第三行 -->
			<div class="row row3">
