...
<head>
	...
	<link rel="stylesheet" href="<%=contextPath %>/css/gys/gyswjmm.css">
</head>
<body>
<!--外围容器-->
...
<!--头部开始-->
	<div class="k_top">
		<div class="k_logo">
			<span class="k_logo1">
				<img src="<%=contextPath %>/images/share/kxwp_logo.png" alt="">
			</span>
			<span>
				<img src="<%=contextPath %>/images/share/title_gys.png" alt="">
			</span>               
		</div>
	</div>
	<!--头部结束-->
	<!--右边开始-->
		<div class="main">
			<form class="wjmm" id="wjmmform" action="/gys/userManage/gysforgotPassword.do" method="POST">
				...
				<p><span>验证码</span><input type="text" id="smscode" name="vercode" placeholder="请输入6位验证码" class="validate[required,custom[number],minSize[6],maxSize[6]]" ><button type="button" id="fsyzm"class="hqyz"  style="border: none;;">获取验证码</button></p>
...
<script src="/js/gys/gyswjmm.js"></script>
<!--end-->
</body>
</html>