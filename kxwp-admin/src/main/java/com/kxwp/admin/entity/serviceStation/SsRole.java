...
public class SsRole {
    ...
    private  List<SsRoleResourceRelation> ssRoleResourceRelations;
    ...
    /**
     * @return  ssRoleResourceRelations
    
     */
    public List<SsRoleResourceRelation> getSsRoleResourceRelations() {
      return ssRoleResourceRelations;
    }

    public void setSsRoleResourceRelations(List<SsRoleResourceRelation> ssRoleResourceRelations) {
      this.ssRoleResourceRelations = ssRoleResourceRelations;
    }
