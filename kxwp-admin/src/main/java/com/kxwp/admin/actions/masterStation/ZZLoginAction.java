 ...
 * @author lou jian wen
 */
@RequestMapping("/zz/user")
@Controller
public class ZZLoginAction {
  ...
  public @ResponseBody ExchangeData msLogin(@Valid @RequestBody LoginForm loginForm,
    ...
    try {
      msLoginService.msLogin(loginForm, request, response);
  ...
  public String logout(HttpServletRequest request, HttpServletResponse response) {
    ...
    return "redirect:/zz/user/index.do";
  }
  ...
  public @ResponseBody ExchangeData autologin(HttpServletRequest request,
    ...
    ExchangeData exchangeData = new ExchangeData();
    try {
      UserModel um = msLoginService.autoLogin(request);
      if (um == null) {
