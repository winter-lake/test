...
<head>
	...
	<title>重置密码</title>
	 ...
	 <link rel="stylesheet" href="<%=contextPath %>/css/gys/gysczmm.css">
</head>
<body>
<!--外围容器-->
<div class="k_contaniner">
	...
	<div class="k_right">
		<div class="content">
			<form class="czmm" action="<%=basePath %>gys/userManage/resetGysPassword.do" method="post">
				...
				<p>
					<button type="button" class="bc" id="czmmsub">确认</button>
...
<script src="<%=contextPath %>/js/gys/gysczmm.js"></script>
<!--end-->
</body>
</html>