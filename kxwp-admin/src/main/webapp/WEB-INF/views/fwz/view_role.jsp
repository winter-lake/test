...
<link rel="stylesheet" href="<%=basePath%>css/fwz/role_detail.css">
...
<body>
	...
	<div class="k_contaniner">
		...
		<div class="k_right">
			<div class="content">
				...
				<div class="row">
					...
					<div class="col-md-4">${ssRole.name }</div>
				</div>
				<div class="row">
					<div class="col-md-2">角色描述 :</div>
					<div class="col-md-4">${ssRole.roleDescription }</div>
				</div>
				...
				<c:forEach items="${newlist }" var="item" varStatus="status">
					<div class="row">
						...
						<c:if test="${iscontain == true}">
							<div class="col-md-2">
								<input disabled="disabled" type="checkbox" checked="checked"
									name="ssResources[${status.index }].id" value="${item.id }">
								${item.name }
							</div>
						</c:if>
						...
						<div class="col-md-4">
							<c:forEach items="${item.ssResources }" var="item2"
								varStatus="status2">
								...
								<c:if test="${iscontain0 == true }">
									<input type="checkbox" disabled="disabled" checked="checked"
										name="ssResources[${status.index }].ssResources[${status2.index }].id"
		...
		<div class="k_breadcrumb">
			...
			<a href="<%=basePath%>fwz/ssRoleManage/list.do" class="add_menu"><i
