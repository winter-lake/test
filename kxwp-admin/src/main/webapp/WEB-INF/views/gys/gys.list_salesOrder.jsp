...
<div class="k_contaniner">
	...
	<div class="k_right">
		<div class="content">
			<div class="z-num" style='width:100%;height:40px;line-height:40px;text-indent:25px;font-size:13px;background:#eee'>
				<span class="text">应收金额合计 :</span>
				<em class="z-price" ><font color="red" id="sumAmount" ></font></em>
			</div>
			<!--查询等功能-->
			<form class="k_change j_search_form" method="post" action="">
				...
				<b class="k-b">
					<i>订单号</i>
					<input type="text" name="orderNo" id="orderNo" placeholder="订单编号">
				</b>
				<b class="k-b">
					<i>手机号</i>
					<input type="text" name=phone placeholder="2343243" id="phone">
				</b>
				<b class="k-b">
					<i>状态</i>
					<select id="order_status" placeholder="全部">
			...
			<!--table-->
			<table class="table table-bordered" style="text-align:center" id="zz_order_list">
...
<!--end-->
	...
	seajs.use("gys/order/list", function(view) {
		view.init();
	});
</script>
</body>
