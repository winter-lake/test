...
<head>
	...
	<link rel="stylesheet" href="<%=basePath %>css/zz/cs.css">
	...
	<div class="k_right">
		<div class="content">
			...
			<form class="k_change" method="post" action="">
				...
				<b class="k-b">
					<i>所属服务站</i>
					<select id="fwz_select" style="width:200px">
...
<!--end-->
	<script src="<%=contextPath %>/js/zz/zz.cscx.js"></script>
</body>
</html>