...
<div class="k_contaniner">
	...
	<div class="k_right">
		<div class="content">
			<form class="form_number" method="post" id="form_menu" action="<%=basePath%>zz/msAccount/add.do">
				<h4>基本信息</h4>
...
$(document).ready(function() {
	$(".icon-chevron-down").click(function(){
		...
		$.ajax({
			type:"POST",
			url:"/zz/msAccount/previewResourceInfo.do",
			dataType:"json",
			data:JSON.stringify(msRoles),
			...
			success:function(response){
				...
				$.each(response, function(i, n){
					  html+='<li class="j_haschild module active"><a href="#"><i class="icon-sitemap tx_16 mr10"></i><span class="name">'+n.name+'</span></a>';
					  		html+='<ul>';
					  	$.each(n.msResources, function(k, v){
    ...
    $(".yes").click(function(){
       ...
       return false;
	  	  ...
	  	  $.ajax({
	  		  type:'POST',
	  		  url:"/zz/msAccount/checkMobileIsUsed.do",
	  		  dataType:"json",
    ...
    Common.hovershow($("#hover"),$("#show"));//第一个参数是当前划过的对象，第二个参数是显示文字的内容区域
})
</script>
</body>
</html>