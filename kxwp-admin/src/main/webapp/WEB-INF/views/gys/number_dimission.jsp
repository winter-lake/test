...
<div class="k_contaniner">
	...
	<div class="k_right">
		<div class="content">
			<!--查询等功能-->
			<form class="k_change" method="post" action="<%=basePath%>gys/suAccount/dimission.do" hidden="true" >
			...
			<table class="table table-bordered" style="text-align:center">
				...
				<tbody>
				    <c:forEach items="${supplierAccounts }" var="item">
						<tr>
...
$(document).ready(function() {
	...
	$(".t_view").click(function(){
		...
		$.ajax({
	        url:"<%=basePath%>gys/suAccount/resetPassword.do?id="+id,
