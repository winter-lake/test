...
<div class="k_contaniner">
	...
	<div class="k_right">
		<div class="content">
			<!--查询等功能-->
			<form class="k_change" method="post" action="<%=basePath%>fwz/ssAccount/dimission.do" hidden="true" >
			...
			<table class="table table-bordered" style="text-align:center">
				...
				<tbody>
				    <c:forEach items="${serviceStationAccounts }" var="item">
						<tr>
...
$(document).ready(function() {
	...
	$(".t_view").click(function(){
		...
		$.ajax({
	        url:"<%=basePath%>fwz/ssAccount/resetPassword.do?id="+id,
