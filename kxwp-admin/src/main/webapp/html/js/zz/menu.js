    ...
    var menu = {
        ...
        dialog:function(){
            ...
            $('.batch_up').click(function(){
              /*判断是否有选中的*/
                ...
                if(!checked){
                    Common.kxpw_tishi("请先选中");
                }else{
                    Common.kxwp_xunwen('确定上线选中内容吗?')
                }
            })
            /*批下*/
        ...
        addmenu:function(){
            ...
            $('#add_url').click(function(){
                $(this).prev('p').append('<b><input type="text" style="margin-top:14px; name="name">&nbsp;&nbsp; <i class="icon-minus" style="cursor:pointer;color:#26a1d0"></i></b>')
            })
