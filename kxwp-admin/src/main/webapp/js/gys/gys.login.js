var gys_index = (function () {
    var index = {
                ...
                success:function(data){
                    if(data.callStatus == "SUCCESS"){
                        ...
                        self.loginSuccess(data);
                    	 ...
                    	 Common.kxpw_tishi(data.message || '网络错误，请稍后重试');
                    	 $("#login_mobile").focus();
                        $(".login").html('登 录');
                    }
                },
        ...
        autoLogin:function(){
            var self = this;
            $.ajax({
                url: '/gys/user/ajax/autoLogin.do',
                type: 'post',
                dataType: 'json',
                data: {},
                global:false,
        ...
        loginSuccess:function(data){
        	window.location.href='/gys/user/gotoDashboard.do';      
        },
        
        validLogin:function(){
        	return $('#gys_login_form').validationEngine('validate');
        },
        ...
        initPage:function(){
            ...
            self.autoLogin();
            //绑定表单验证
            Common.validator($("#gys_login_form"));
            // 绑定快捷键
