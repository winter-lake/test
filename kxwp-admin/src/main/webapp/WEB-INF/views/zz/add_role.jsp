...
<div class="k_contaniner">
	...
	<div class="k_right">
		<div class="content">
			<form class="add_form_role" method="post" id="form_menu" action="<%=basePath %>zz/msRoleManage/add.do">
				<div class="div">
					<span><i class="icon-asterisk tx_red"></i> 角色名 :</span> 
				    <input type="text" name="name" placeholder="角色名" style="width:250px;border:1px solid #eee;height:30px;" data-required>
				</div>
				<div class="div">
					<span>角色描述 :</span> 
