...
<body>
		...
		<div class="content">
			<div class="row" id="row">
			  ...
			  <div class="col-md-12" style="text-align: center;">
			      	<a href="/fwz/manager/salesOrder/gotoPrintSalesOrder.do?orderID=${salesOrder_detail.id}" target="_blank"><button class="btn btn-info" >打印发货单</button></a>
			  </div>
			</div>
	...
	<!--右边结束-->
		...
		<div class="k_breadcrumb">
			...
			<a href="<%=contextPath %>/fwz/manager/salesOrder/gotolistSalesOrder.do" class="add_menu">订单列表</a>
		</div>
		<!--面包屑导航结束-->
		<!--footer开始-->
