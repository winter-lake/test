...
<head>
	...
	<link rel="stylesheet" href="<%=contextPath %>/css/zz/zzwjmm.css">
</head>
<body>
<!--外围容器-->
...
<!--头部开始-->
	<div class="k_top">
		<div class="k_logo">
			...
			<span>
				<img src="../../images/share/title_zz.png" alt="">
			</span>               
		</div>
	</div>
	<!--头部结束-->
	<!--右边开始-->
		<div class="main">
			<form class="wjmm" id="wjmmform" action="/zz/userManage/forgotPassword.do" method="POST">
...
<script src="/js/zz/zzwjmm.js"></script>
<!--end-->
</body>
</html>